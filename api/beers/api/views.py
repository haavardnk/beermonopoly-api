...
class BeerViewSet(StaffBrowsableMixin, ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if (
            ...
            and strtobool(user_checkin) is True
            ...
            user_checkin is not None
            and strtobool(user_checkin) is False
            and self.request.user
            and self.request.user.is_authenticated
        ):
        ...
        if (
            ...
            and strtobool(user_tasted) is True
            and self.request.user
            and self.request.user.is_authenticated
        ):
            ...
            user_tasted is not None
            and strtobool(user_tasted) is False
            and self.request.user
            and self.request.user.is_authenticated
        ):
        ...
        if (
            ...
            and strtobool(user_wishlisted) is True
            and self.request.user
            and self.request.user.is_authenticated
        ):
            ...
            user_wishlisted is not None
            and strtobool(user_wishlisted) is False
            and self.request.user
            and self.request.user.is_authenticated
        ):
